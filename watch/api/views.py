...
from watch.api.permissions import AdminorReadOnly, ReviewUserorReadOnly
...
class ReviewCreate(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        watch_content = WatchList.objects.get(pk=pk)
        print(watch_content)
        serializer.save(watchlist=watch_content)
...
class WatchLists(generics.ListCreateAPIView):
